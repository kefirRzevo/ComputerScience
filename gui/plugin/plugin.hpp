...
class ITexture 
{
    public:
        ...
        virtual void DrawThickLine(int x0, int y0, int x1, int y1, int thickness, Color color) = 0;
        ...
        virtual void CopyTexture(ITexture* texture, int x, int y, int width, int height) = 0;
};
...
class IWidgetFactory
{
    public:
        ...
        virtual IButton* CreateButtonWithIcon(int width, int height, const char* icon_file_name) = 0;
        virtual IButton* CreateButtonWithText(int width, int height, const char* text, int char_size) = 0;

        virtual ISlider* CreateDefaultSlider(float range_min, float range_max) = 0;
        virtual ISlider* CreateSlider(int width, int height, float range_min, float range_max) = 0;
        virtual ISlider* CreateSlider(int width, int height, float thumb_width, float thumb_height, float range_min, float range_max) = 0;

        virtual ILabel*  CreateDefaultLabel(const char* text) = 0;
        virtual ILabel*  CreateLabel(int width, int height, const char* text, int char_size) = 0;
