...
public:
  ...
  IButton *CreateDefaultButtonWithIcon(const char *iconPath) override;
  IButton *CreateDefaultButtonWithText(const char *text) override;
  IButton *CreateButtonWithIcon(int width, int height,
                                const char *icon_file_name) override;
  IButton *CreateButtonWithText(int width, int height, const char *text,
                                int char_size) override;

  ISlider *CreateDefaultSlider(float range_min, float range_max) override;
  ISlider *CreateSlider(int width, int height, float range_min,
                        float range_max) override;
  ISlider *CreateSlider(int width, int height, float boxWidth, float boxHeight,
                        float min, float max) override;

  ILabel *CreateDefaultLabel(const char *text) override;
  ILabel *CreateLabel(int width, int height, const char *text,
                      int char_size) override;
...
public:
  ...
  void SetCallback(IClickCallback *callback_);
...
public:
  ...
  void SetCallback(ISliderCallback *callback_);
...
public:
  virtual Widget *GetBasicWidget() = 0;
};
...
public:
  ...
  Widget *GetBasicWidget() override;
  int GetWidth() override;
  int GetHeight() override;

  void SetClickCallback(IClickCallback *callback_) override;
...
public:
  ...
  void SetSliderCallback(ISliderCallback *callback_) override;
...
public:
  ...
  void SetText(const char *text_) override;
...
public:
  ...
  void Attach(IWidget *widget, int x, int y) override;
