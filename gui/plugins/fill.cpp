...
const char *FillTool::GetName() const { return "Fill"; }

FillTool::FillTool() : color_(0xFF'00'00'FF), panel_(nullptr) {}
...
void FillTool::ActionEnd(ITexture *canvas, int x, int y) { assert(canvas); }

const char *FillTool::GetIconFileName() const { return "res/fill.bmp"; }

IPreferencesPanel *FillTool::GetPreferencesPanel() const { return panel_; }

class Plugin : public IPlugin {
public:
  Plugin(FillTool *fill_tool) : fill_tool_(fill_tool) {}
...
Plugin::~Plugin() { delete fill_tool_; }
