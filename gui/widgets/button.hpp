...
public:
  ...
  static Button *GetDefault(const std::string &string_,
                            ButtonResponse *response_);

  bool GetPressed() const;

  void SetButtonResponse(ButtonResponse *response_);
...
public:
  ...
  static OptionButton *GetDefault(const std::string &string_,
                                  ButtonResponse *response_);
...
public:
  ...
  static CloseButton *GetDefault(Widget *toClose_);
};
