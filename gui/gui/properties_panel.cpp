...
HideCommand::HideCommand(PropertiesPanel* panel_):
panel(panel_)
{}

void
HideCommand::OnResponse()
{
    panel->Hide();
}
...
HideButton*
HideButton::GetDefault(PropertiesPanel* panel_)
{
...
PropertiesPanel*
PropertiesPanel::GetDefault(Texture* texture_)
{
...
bool
PropertiesPanel::ProcessEvent(const Event& event_)
{
    if(visible)
...
bool
PropertiesPanel::ProcessListenerEvent(const Event& event_)
{
    if(visible)
    {
...
bool
PropertiesPanel::OnEvent(const Event& event_)
{
    if(visible)
    {
...
void
PropertiesPanel::RenderBorder() const
{
    if(visible)
        Widget::RenderBorder();
}
