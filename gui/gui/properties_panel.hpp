...
public:
  HideButton(Layout *layout_, PropertiesPanel *panel_, Texture *onRelease_,
             Texture *onHover_ = nullptr, Texture *onPress_ = nullptr);

  static HideButton *GetDefault(PropertiesPanel *panel_);
};
...
public:
  ...
  static PropertiesPanel *GetDefault(Texture *texture_);
